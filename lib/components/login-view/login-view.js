...
function LoginView(props) {
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    _axios["default"].post("https://nikairu-flix-app.herokuapp.com/login?Username=".concat(encodeURIComponent(username), "&Password=").concat(encodeURIComponent(password))).then(function (response) {
